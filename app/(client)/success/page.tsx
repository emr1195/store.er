      ...
      >
        ...
        <div className="space-y-4 mb-8 text-left">
          <p className="text-gray-700">
            Gracias Por su compra. Esta&apos;remos procesando su orden y se enviara lo antes posible. Recibiras un correo con la confirmacion de la compra
          </p>
          <p className="text-gray-700">
            Numero de Orden:{" "}
        ...
        <div className="mb-8">
          <h3 className="font-semibold text-gray-900 mb-2">Compras Recientes</h3>
